...
CONFIG_PATH="${CONFIG_PATH:-$PROJECT_ROOT/configs/qformer_q32_cov_5e-5_curriculum.yaml}"

HS_ROOT="${HS_ROOT:-$PROJECT_ROOT/outputs/feasibility_dataset/hidden_states}"
RUN_TAG="${RUN_TAG:-qformer_q32_cov_5e-5_curriculum}"
...
PHASE_SPECS=(
  "p1_bootstrap|32768|6|1e-4|256|8k,32k|8k=0.70,32k=0.30|8k=8,32k=4"
  "p2_bridge|131072|5|7e-5|256|8k,32k,128k|8k=0.20,32k=0.60,128k=0.20|8k=8,32k=4,128k=2"
  "p3_long|1048576|4|4e-5|128|32k,128k,1m|32k=0.20,128k=0.70,1m=0.10|32k=4,128k=2,1m=1"
  "p4_adapt|1048576|2|2e-5|128|128k,1m|128k=0.80,1m=0.20|128k=1,1m=1"
)
...
Phases:
  p1_bootstrap: 8k/32k, weights 0.70/0.30, batch sizes 8/4, 256 steps/epoch, 6 epochs, lr 1e-4
  p2_bridge: 8k/32k/128k, weights 0.20/0.60/0.20, batch sizes 8/4/2, 256 steps/epoch, 5 epochs, lr 7e-5
  p3_long: 32k/128k/1m, weights 0.20/0.70/0.10, batch sizes 4/2/1, 128 steps/epoch, 4 epochs, lr 4e-5
  p4_adapt: 128k/1m, weights 0.80/0.20, batch sizes 1/1, 128 steps/epoch, 2 epochs, lr 2e-5
EOF
